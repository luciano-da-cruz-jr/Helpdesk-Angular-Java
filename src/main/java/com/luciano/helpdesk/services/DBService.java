...
import com.luciano.helpdesk.domain.enums.Perfil;
import com.luciano.helpdesk.domain.enums.Prioridade;
import com.luciano.helpdesk.domain.enums.Status;
...
public class DBService {
	...
	public void instanciaDB() {
		...
		Tecnico tec = new Tecnico(null, "root", "720.469.060-55", "root@mail.com", encoder.encode("root"));
		tec.addPerfil(Perfil.ADMIN);
		Tecnico tec0 = new Tecnico(null, "Luciano da Cruz Júnior", "783.926.560-08", "luciano@mail.com", encoder.encode("123"));
		...
		pessoaRepository.saveAll(Arrays.asList(tec, tec0, tec1, tec2, tec3, tec4, tec5, cli1, cli2, cli3, cli4, cli5));
